...
urlpatterns = [
    ...
    path('api/repair/<int:repair_id>/diagnosis/', api_views.repair_diagnosis_data, name='api_repair_diagnosis_data'),
    path('api/repair/<int:repair_id>/diagnosis/submit/', api_views.repair_diagnosis_submit, name='api_repair_diagnosis_submit'),
